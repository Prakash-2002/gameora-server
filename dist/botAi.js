...
exports.decidePlayCard = exports.decideTrumpSuit = exports.decideBid = void 0;
const getPartnerIndex = (playerIndex) => {
    return (playerIndex + 2) % 4;
};
const isPartner = (playerIndex, botIndex) => {
    return getPartnerIndex(botIndex) === playerIndex;
};
const decideBid = (hand, currentBid, botIndex, bidWinner) => {
...
const decideTrumpSuit = (hand) => {
    const suitScores = { spades: 0, hearts: 0, diamonds: 0, clubs: 0 };
    for (const card of hand) {
        let cardScore = 1;
        if (card.rank === 'J')
            cardScore = 5;
    ...
    let bestSuit = 'spades';
    let maxScore = -1;
    for (const suit of Object.keys(suitScores)) {
...
exports.decideTrumpSuit = decideTrumpSuit;
const decidePlayCard = (hand, currentTrick, isTrumpRevealed, trumpSuitSecret, botIndex) => {
...
exports.decidePlayCard = decidePlayCard;
